...
class PostCustomersCustomerSources extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    protected $customer;
     ...
     */
    public function __construct(string $customer, \Stripe\Api\Model\V1CustomersCustomerSourcesPostBody $payload)
    {

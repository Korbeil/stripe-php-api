...
class GetSourcesSourceSourceTransactions extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    protected $source;
    ...
    {
        return str_replace(['{source}'], [$this->source], '/v1/sources/{source}/source_transactions');
    }
     ...
     *
     *
     * @return \Stripe\Api\Model\V1SourcesSourceSourceTransactionsGetResponse200|\Stripe\Api\Model\Error|null
     */
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer)
    {
        if (200 === $status) {
            return $serializer->deserialize($body, 'Stripe\\Api\\Model\\V1SourcesSourceSourceTransactionsGetResponse200', 'json');
        }

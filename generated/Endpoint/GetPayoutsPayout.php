...
class GetPayoutsPayout extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    protected $payout;
     ...
     * }
     */
    public function __construct(string $payout, array $queryParameters = [])
    {
        $this->payout = $payout;

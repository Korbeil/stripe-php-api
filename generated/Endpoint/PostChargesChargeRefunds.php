...
class PostChargesChargeRefunds extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    protected $charge;
     ...
     */
    public function __construct(string $charge, \Stripe\Api\Model\V1ChargesChargeRefundsPostBody $payload)
    {
        $this->charge = $charge;
        $this->body = $payload;
    }

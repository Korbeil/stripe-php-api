...
class GetBitcoinReceivers extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    /**
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['expand', 'active', 'ending_before', 'filled', 'limit', 'starting_after', 'uncaptured_funds']);
        ...
        $optionsResolver->setAllowedTypes('filled', ['bool']);
        $optionsResolver->setAllowedTypes('limit', ['int']);
        $optionsResolver->setAllowedTypes('starting_after', ['string']);
        $optionsResolver->setAllowedTypes('uncaptured_funds', ['bool']);
     ...
     *
     *
     * @return \Stripe\Api\Model\V1BitcoinReceiversGetResponse200|\Stripe\Api\Model\Error|null
     */
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer)
    {
        if (200 === $status) {
            return $serializer->deserialize($body, 'Stripe\\Api\\Model\\V1BitcoinReceiversGetResponse200', 'json');
        }

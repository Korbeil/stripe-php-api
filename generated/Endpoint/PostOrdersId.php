...
class PostOrdersId extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    protected $id;
     ...
     */
    public function __construct(string $id, \Stripe\Api\Model\V1OrdersIdPostBody $payload)
    {
        $this->id = $id;
        $this->body = $payload;
    }

...
class GetRadarValueListItems extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    /**
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['expand', 'created', 'ending_before', 'limit', 'starting_after', 'value', 'value_list']);
        $optionsResolver->setRequired(['value_list']);
        ...
        $optionsResolver->setAllowedTypes('value_list', ['string']);
     ...
     *
     *
     * @return \Stripe\Api\Model\V1RadarValueListItemsGetResponse200|\Stripe\Api\Model\Error|null
     */
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer)
    {
        if (200 === $status) {
            return $serializer->deserialize($body, 'Stripe\\Api\\Model\\V1RadarValueListItemsGetResponse200', 'json');
        }

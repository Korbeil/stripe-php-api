...
class PostOrders extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    /**
     ...
     */
    public function __construct(\Stripe\Api\Model\V1OrdersPostBody $payload)
    {
        $this->body = $payload;
    }

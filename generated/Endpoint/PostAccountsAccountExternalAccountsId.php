...
class PostAccountsAccountExternalAccountsId extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    protected $account;
    protected $id;
     ...
     */
    public function __construct(string $account, string $id, \Stripe\Api\Model\V1AccountsAccountExternalAccountsIdPostBody $payload)
    {

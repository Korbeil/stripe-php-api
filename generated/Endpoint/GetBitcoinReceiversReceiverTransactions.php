...
class GetBitcoinReceiversReceiverTransactions extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    protected $receiver;
     ...
     * }
     */
    public function __construct(string $receiver, array $queryParameters = [])
    {
    ...
    {
        return str_replace(['{receiver}'], [$this->receiver], '/v1/bitcoin/receivers/{receiver}/transactions');
    }
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['expand', 'customer', 'ending_before', 'limit', 'starting_after']);
     ...
     *
     *
     * @return \Stripe\Api\Model\V1BitcoinReceiversReceiverTransactionsGetResponse200|\Stripe\Api\Model\Error|null
     */
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer)
    {
        if (200 === $status) {
            return $serializer->deserialize($body, 'Stripe\\Api\\Model\\V1BitcoinReceiversReceiverTransactionsGetResponse200', 'json');
        }

...
class GetFileLinksLink extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    protected $link;
     ...
     * }
     */
    public function __construct(string $link, array $queryParameters = [])
    {
        $this->link = $link;

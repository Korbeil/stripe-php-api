...
class GetAccountPersonsPerson extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    protected $person;
     ...
     * }
     */
    public function __construct(string $person, array $queryParameters = [])
    {
        $this->person = $person;

...
class GetSigmaScheduledQueryRuns extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    /**
     ...
     *
     *
     * @return \Stripe\Api\Model\V1SigmaScheduledQueryRunsGetResponse200|\Stripe\Api\Model\Error|null
     */
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer)
    {
        if (200 === $status) {
            return $serializer->deserialize($body, 'Stripe\\Api\\Model\\V1SigmaScheduledQueryRunsGetResponse200', 'json');
        }

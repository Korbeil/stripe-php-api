...
class GetSubscriptionItemsSubscriptionItemUsageRecordSummaries extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
     ...
     * }
     */
    public function __construct(string $subscriptionItem, array $queryParameters = [])
    {
    ...
    {
        return str_replace(['{subscription_item}'], [$this->subscription_item], '/v1/subscription_items/{subscription_item}/usage_record_summaries');
    }
     ...
     *
     *
     * @return \Stripe\Api\Model\V1SubscriptionItemsSubscriptionItemUsageRecordSummariesGetResponse200|\Stripe\Api\Model\Error|null
     */
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer)
    {
        if (200 === $status) {
            return $serializer->deserialize($body, 'Stripe\\Api\\Model\\V1SubscriptionItemsSubscriptionItemUsageRecordSummariesGetResponse200', 'json');
        }

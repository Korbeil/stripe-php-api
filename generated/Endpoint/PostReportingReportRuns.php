...
class PostReportingReportRuns extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    /**
     ...
     */
    public function __construct(\Stripe\Api\Model\V1ReportingReportRunsPostBody $payload)
    {
        $this->body = $payload;
    }

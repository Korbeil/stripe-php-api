...
class PostSources extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    /**
     ...
     */
    public function __construct(\Stripe\Api\Model\V1SourcesPostBody $payload)
    {
        $this->body = $payload;
    }

...
class PostAccountExternalAccountsId extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    protected $id;
     ...
     */
    public function __construct(string $id, \Stripe\Api\Model\V1AccountExternalAccountsIdPostBody $payload)
    {
        $this->id = $id;
        $this->body = $payload;
    }

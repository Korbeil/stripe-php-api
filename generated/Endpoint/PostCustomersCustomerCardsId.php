...
class PostCustomersCustomerCardsId extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    protected $customer;
    protected $id;
     ...
     */
    public function __construct(string $customer, string $id, \Stripe\Api\Model\V1CustomersCustomerCardsIdPostBody $payload)
    {

...
class GetIssuingTransactions extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    /**
    ...
    {
        return '/v1/issuing/transactions';
    }
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['expand', 'card', 'cardholder', 'created', 'dispute', 'ending_before', 'limit', 'settlement', 'starting_after']);
        ...
        $optionsResolver->setAllowedTypes('dispute', ['string']);
        $optionsResolver->setAllowedTypes('ending_before', ['string']);
        $optionsResolver->setAllowedTypes('limit', ['int']);
        $optionsResolver->setAllowedTypes('settlement', ['string']);
     ...
     *
     *
     * @return \Stripe\Api\Model\V1IssuingTransactionsGetResponse200|\Stripe\Api\Model\Error|null
     */
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer)
    {
        if (200 === $status) {
            return $serializer->deserialize($body, 'Stripe\\Api\\Model\\V1IssuingTransactionsGetResponse200', 'json');
        }

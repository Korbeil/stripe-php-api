...
class V1AccountsAccountPersonsPersonPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Stripe\\Api\\Model\\V1AccountsAccountPersonsPersonPostBody';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Stripe\Api\Model\V1AccountsAccountPersonsPersonPostBody;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Stripe\Api\Model\V1AccountsAccountPersonsPersonPostBody();
        if (property_exists($data, 'address')) {
            $object->setAddress($this->denormalizer->denormalize($data->{'address'}, 'Stripe\\Api\\Model\\V1AccountsAccountPersonsPersonPostBodyAddress', 'json', $context));
        }
        if (property_exists($data, 'address_kana')) {
            $object->setAddressKana($this->denormalizer->denormalize($data->{'address_kana'}, 'Stripe\\Api\\Model\\V1AccountsAccountPersonsPersonPostBodyAddressKana', 'json', $context));
        }
        if (property_exists($data, 'address_kanji')) {
            $object->setAddressKanji($this->denormalizer->denormalize($data->{'address_kanji'}, 'Stripe\\Api\\Model\\V1AccountsAccountPersonsPersonPostBodyAddressKanji', 'json', $context));
        }
        if (property_exists($data, 'dob')) {
            $object->setDob($this->denormalizer->denormalize($data->{'dob'}, 'Stripe\\Api\\Model\\V1AccountsAccountPersonsPersonPostBodyDob', 'json', $context));
        }
        ...
        if (property_exists($data, 'relationship')) {
            $object->setRelationship($this->denormalizer->denormalize($data->{'relationship'}, 'Stripe\\Api\\Model\\V1AccountsAccountPersonsPersonPostBodyRelationship', 'json', $context));
        }
        if (property_exists($data, 'ssn_last_4')) {
            $object->setSsnLast4($data->{'ssn_last_4'});
        }
        if (property_exists($data, 'verification')) {
            $object->setVerification($this->denormalizer->denormalize($data->{'verification'}, 'Stripe\\Api\\Model\\V1AccountsAccountPersonsPersonPostBodyVerification', 'json', $context));
        }

...
class LegalEntityCompanyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Stripe\\Api\\Model\\LegalEntityCompany';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Stripe\Api\Model\LegalEntityCompany;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Stripe\Api\Model\LegalEntityCompany();
        ...
        if (property_exists($data, 'tax_id_provided')) {
            $object->setTaxIdProvided($data->{'tax_id_provided'});
        }
        if (property_exists($data, 'tax_id_registrar')) {
            $object->setTaxIdRegistrar($data->{'tax_id_registrar'});
        }
        if (property_exists($data, 'vat_id_provided')) {
            $object->setVatIdProvided($data->{'vat_id_provided'});
        }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getTaxIdProvided()) {
            $data->{'tax_id_provided'} = $object->getTaxIdProvided();
        }
        if (null !== $object->getTaxIdRegistrar()) {
            $data->{'tax_id_registrar'} = $object->getTaxIdRegistrar();
        }
        if (null !== $object->getVatIdProvided()) {
            $data->{'vat_id_provided'} = $object->getVatIdProvided();
        }

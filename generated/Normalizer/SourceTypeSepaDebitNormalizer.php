...
class SourceTypeSepaDebitNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Stripe\\Api\\Model\\SourceTypeSepaDebit';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Stripe\Api\Model\SourceTypeSepaDebit;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Stripe\Api\Model\SourceTypeSepaDebit();
        ...
        if (property_exists($data, 'mandate_url')) {
            $object->setMandateUrl($data->{'mandate_url'});
        }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getMandateUrl()) {
            $data->{'mandate_url'} = $object->getMandateUrl();
        }

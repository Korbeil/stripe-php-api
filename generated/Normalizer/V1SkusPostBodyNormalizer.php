...
class V1SkusPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Stripe\\Api\\Model\\V1SkusPostBody';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Stripe\Api\Model\V1SkusPostBody;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Stripe\Api\Model\V1SkusPostBody();
        ...
        if (property_exists($data, 'inventory')) {
            $object->setInventory($this->denormalizer->denormalize($data->{'inventory'}, 'Stripe\\Api\\Model\\V1SkusPostBodyInventory', 'json', $context));
        }
        if (property_exists($data, 'metadata')) {
            $object->setMetadata($data->{'metadata'});
        }
        if (property_exists($data, 'package_dimensions')) {
            $object->setPackageDimensions($this->denormalizer->denormalize($data->{'package_dimensions'}, 'Stripe\\Api\\Model\\V1SkusPostBodyPackageDimensions', 'json', $context));
        }

...
class V1AccountsAccountPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Stripe\\Api\\Model\\V1AccountsAccountPostBody';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Stripe\Api\Model\V1AccountsAccountPostBody;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Stripe\Api\Model\V1AccountsAccountPostBody();
        ...
        if (property_exists($data, 'business_profile')) {
            $object->setBusinessProfile($this->denormalizer->denormalize($data->{'business_profile'}, 'Stripe\\Api\\Model\\V1AccountsAccountPostBodyBusinessProfile', 'json', $context));
        }
        if (property_exists($data, 'business_type')) {
            $object->setBusinessType($data->{'business_type'});
        }
        if (property_exists($data, 'company')) {
            $object->setCompany($this->denormalizer->denormalize($data->{'company'}, 'Stripe\\Api\\Model\\V1AccountsAccountPostBodyCompany', 'json', $context));
        }
        ...
        if (property_exists($data, 'individual')) {
            $object->setIndividual($this->denormalizer->denormalize($data->{'individual'}, 'Stripe\\Api\\Model\\V1AccountsAccountPostBodyIndividual', 'json', $context));
        }
        ...
        if (property_exists($data, 'settings')) {
            $object->setSettings($this->denormalizer->denormalize($data->{'settings'}, 'Stripe\\Api\\Model\\V1AccountsAccountPostBodySettings', 'json', $context));
        }
        if (property_exists($data, 'tos_acceptance')) {
            $object->setTosAcceptance($this->denormalizer->denormalize($data->{'tos_acceptance'}, 'Stripe\\Api\\Model\\V1AccountsAccountPostBodyTosAcceptance', 'json', $context));
        }

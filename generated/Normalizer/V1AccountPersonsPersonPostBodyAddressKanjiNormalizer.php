...
class V1AccountPersonsPersonPostBodyAddressKanjiNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Stripe\\Api\\Model\\V1AccountPersonsPersonPostBodyAddressKanji';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Stripe\Api\Model\V1AccountPersonsPersonPostBodyAddressKanji;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Stripe\Api\Model\V1AccountPersonsPersonPostBodyAddressKanji();

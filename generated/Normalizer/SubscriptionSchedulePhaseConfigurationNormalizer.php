...
class SubscriptionSchedulePhaseConfigurationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Stripe\\Api\\Model\\SubscriptionSchedulePhaseConfiguration';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Stripe\Api\Model\SubscriptionSchedulePhaseConfiguration;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Stripe\Api\Model\SubscriptionSchedulePhaseConfiguration();
        ...
        if (property_exists($data, 'plans')) {
            ...
            foreach ($data->{'plans'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Stripe\\Api\\Model\\SubscriptionScheduleConfigurationItem', 'json', $context);
            }

...
class V1ProductsIdPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Stripe\\Api\\Model\\V1ProductsIdPostBody';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Stripe\Api\Model\V1ProductsIdPostBody;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Stripe\Api\Model\V1ProductsIdPostBody();
        ...
        if (property_exists($data, 'package_dimensions')) {
            $object->setPackageDimensions($this->denormalizer->denormalize($data->{'package_dimensions'}, 'Stripe\\Api\\Model\\V1ProductsIdPostBodyPackageDimensions', 'json', $context));
        }

...
class V1SubscriptionSchedulesSchedulePostBodyPhasesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Stripe\\Api\\Model\\V1SubscriptionSchedulesSchedulePostBodyPhasesItem';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Stripe\Api\Model\V1SubscriptionSchedulesSchedulePostBodyPhasesItem;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Stripe\Api\Model\V1SubscriptionSchedulesSchedulePostBodyPhasesItem();
        ...
        if (property_exists($data, 'plans')) {
            ...
            foreach ($data->{'plans'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Stripe\\Api\\Model\\V1SubscriptionSchedulesSchedulePostBodyPhasesItemPlansItem', 'json', $context);
            }

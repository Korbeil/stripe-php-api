...
class PayoutNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Stripe\\Api\\Model\\Payout';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Stripe\Api\Model\Payout;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Stripe\Api\Model\Payout();
        if (property_exists($data, 'amount')) {
            $object->setAmount($data->{'amount'});
        }
        if (property_exists($data, 'arrival_date')) {
            $object->setArrivalDate($data->{'arrival_date'});
        }
        if (property_exists($data, 'automatic')) {
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getArrivalDate()) {
            $data->{'arrival_date'} = $object->getArrivalDate();
        }
        if (null !== $object->getAutomatic()) {
            $data->{'automatic'} = $object->getAutomatic();
        }

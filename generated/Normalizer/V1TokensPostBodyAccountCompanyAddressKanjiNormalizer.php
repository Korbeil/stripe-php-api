...
class V1TokensPostBodyAccountCompanyAddressKanjiNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Stripe\\Api\\Model\\V1TokensPostBodyAccountCompanyAddressKanji';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Stripe\Api\Model\V1TokensPostBodyAccountCompanyAddressKanji;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Stripe\Api\Model\V1TokensPostBodyAccountCompanyAddressKanji();

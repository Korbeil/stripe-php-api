...
class V1InvoiceitemsInvoiceitemPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Stripe\\Api\\Model\\V1InvoiceitemsInvoiceitemPostBody';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Stripe\Api\Model\V1InvoiceitemsInvoiceitemPostBody;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Stripe\Api\Model\V1InvoiceitemsInvoiceitemPostBody();
        ...
        if (property_exists($data, 'period')) {
            $object->setPeriod($this->denormalizer->denormalize($data->{'period'}, 'Stripe\\Api\\Model\\V1InvoiceitemsInvoiceitemPostBodyPeriod', 'json', $context));
        }

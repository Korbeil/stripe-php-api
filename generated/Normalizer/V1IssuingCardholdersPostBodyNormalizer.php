...
class V1IssuingCardholdersPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Stripe\\Api\\Model\\V1IssuingCardholdersPostBody';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Stripe\Api\Model\V1IssuingCardholdersPostBody;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Stripe\Api\Model\V1IssuingCardholdersPostBody();
        if (property_exists($data, 'billing')) {
            $object->setBilling($this->denormalizer->denormalize($data->{'billing'}, 'Stripe\\Api\\Model\\V1IssuingCardholdersPostBodyBilling', 'json', $context));
        }

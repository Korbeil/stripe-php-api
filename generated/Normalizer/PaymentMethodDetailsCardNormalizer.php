...
class PaymentMethodDetailsCardNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Stripe\\Api\\Model\\PaymentMethodDetailsCard';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Stripe\Api\Model\PaymentMethodDetailsCard;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Stripe\Api\Model\PaymentMethodDetailsCard();
        if (property_exists($data, 'brand')) {
            $object->setBrand($data->{'brand'});
        }
        if (property_exists($data, 'checks')) {
            $object->setChecks($this->denormalizer->denormalize($data->{'checks'}, 'Stripe\\Api\\Model\\PaymentMethodDetailsCardChecks', 'json', $context));
        }
        ...
        if (property_exists($data, 'three_d_secure')) {
            $object->setThreeDSecure($this->denormalizer->denormalize($data->{'three_d_secure'}, 'Stripe\\Api\\Model\\ThreeDSecureDetails', 'json', $context));
        }
        if (property_exists($data, 'wallet')) {
            $object->setWallet($this->denormalizer->denormalize($data->{'wallet'}, 'Stripe\\Api\\Model\\PaymentMethodDetailsCardWallet', 'json', $context));
        }

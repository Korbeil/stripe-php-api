...
class V1CustomersCustomerSubscriptionsSubscriptionExposedIdPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Stripe\\Api\\Model\\V1CustomersCustomerSubscriptionsSubscriptionExposedIdPostBody';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Stripe\Api\Model\V1CustomersCustomerSubscriptionsSubscriptionExposedIdPostBody;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Stripe\Api\Model\V1CustomersCustomerSubscriptionsSubscriptionExposedIdPostBody();
        ...
        if (property_exists($data, 'items')) {
            ...
            foreach ($data->{'items'} as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Stripe\\Api\\Model\\V1CustomersCustomerSubscriptionsSubscriptionExposedIdPostBodyItemsItem', 'json', $context);
            }

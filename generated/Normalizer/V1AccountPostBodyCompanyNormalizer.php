...
class V1AccountPostBodyCompanyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Stripe\\Api\\Model\\V1AccountPostBodyCompany';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Stripe\Api\Model\V1AccountPostBodyCompany;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Stripe\Api\Model\V1AccountPostBodyCompany();
        if (property_exists($data, 'address')) {
            $object->setAddress($this->denormalizer->denormalize($data->{'address'}, 'Stripe\\Api\\Model\\V1AccountPostBodyCompanyAddress', 'json', $context));
        }
        if (property_exists($data, 'address_kana')) {
            $object->setAddressKana($this->denormalizer->denormalize($data->{'address_kana'}, 'Stripe\\Api\\Model\\V1AccountPostBodyCompanyAddressKana', 'json', $context));
        }
        if (property_exists($data, 'address_kanji')) {
            $object->setAddressKanji($this->denormalizer->denormalize($data->{'address_kanji'}, 'Stripe\\Api\\Model\\V1AccountPostBodyCompanyAddressKanji', 'json', $context));
        }

...
class V1AccountPostBodyCompany
{
    /**
     * @var V1AccountPostBodyCompanyAddress
     */
    protected $address;
    /**
     * @var V1AccountPostBodyCompanyAddressKana
     */
    protected $addressKana;
    /**
     * @var V1AccountPostBodyCompanyAddressKanji
     */
    ...
    /**
     * @return V1AccountPostBodyCompanyAddress
     */
    public function getAddress(): ?V1AccountPostBodyCompanyAddress
    {
        return $this->address;
    }

    /**
     * @param V1AccountPostBodyCompanyAddress $address
     *
     * @return self
     */
    public function setAddress(?V1AccountPostBodyCompanyAddress $address): self
    {
    ...
    /**
     * @return V1AccountPostBodyCompanyAddressKana
     */
    public function getAddressKana(): ?V1AccountPostBodyCompanyAddressKana
    {
        return $this->addressKana;
    }

    /**
     * @param V1AccountPostBodyCompanyAddressKana $addressKana
     *
     * @return self
     */
    public function setAddressKana(?V1AccountPostBodyCompanyAddressKana $addressKana): self
    {
    ...
    /**
     * @return V1AccountPostBodyCompanyAddressKanji
     */
    public function getAddressKanji(): ?V1AccountPostBodyCompanyAddressKanji
    {
        return $this->addressKanji;
    }

    /**
     * @param V1AccountPostBodyCompanyAddressKanji $addressKanji
     *
     * @return self
     */
    public function setAddressKanji(?V1AccountPostBodyCompanyAddressKanji $addressKanji): self
    {

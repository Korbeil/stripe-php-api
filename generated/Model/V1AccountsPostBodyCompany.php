...
class V1AccountsPostBodyCompany
{
    /**
     * @var V1AccountsPostBodyCompanyAddress
     */
    protected $address;
    /**
     * @var V1AccountsPostBodyCompanyAddressKana
     */
    protected $addressKana;
    /**
     * @var V1AccountsPostBodyCompanyAddressKanji
     */
    ...
    /**
     * @return V1AccountsPostBodyCompanyAddress
     */
    public function getAddress(): ?V1AccountsPostBodyCompanyAddress
    {
        return $this->address;
    }

    /**
     * @param V1AccountsPostBodyCompanyAddress $address
     *
     * @return self
     */
    public function setAddress(?V1AccountsPostBodyCompanyAddress $address): self
    {
    ...
    /**
     * @return V1AccountsPostBodyCompanyAddressKana
     */
    public function getAddressKana(): ?V1AccountsPostBodyCompanyAddressKana
    {
        return $this->addressKana;
    }

    /**
     * @param V1AccountsPostBodyCompanyAddressKana $addressKana
     *
     * @return self
     */
    public function setAddressKana(?V1AccountsPostBodyCompanyAddressKana $addressKana): self
    {
    ...
    /**
     * @return V1AccountsPostBodyCompanyAddressKanji
     */
    public function getAddressKanji(): ?V1AccountsPostBodyCompanyAddressKanji
    {
        return $this->addressKanji;
    }

    /**
     * @param V1AccountsPostBodyCompanyAddressKanji $addressKanji
     *
     * @return self
     */
    public function setAddressKanji(?V1AccountsPostBodyCompanyAddressKanji $addressKanji): self
    {
